...
## Project Structure
    ...
    ├── reportes_tecnicos_a_38024  # Django project configurations
...
1. Clone this repo and `cd reportes_tecnicos_a_38024`
...
2. Clone this repo and `cd reportes_tecnicos_a_38024`
